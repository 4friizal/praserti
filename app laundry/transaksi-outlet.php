			...
			<div class="row">
				...
				<div class="col-lg-12">
					<div class="col-lg-12 latar_konten">
						...
						<br><a href="transaksi-tambah.php?outlet=<?php echo $_GET['outlet']; ?>" class="btn btn-info btn-block">Tambah Transaksi</a><br>
						<table class="table table-bordered table-striped table-hover">
							...
							<tr>
								...
								<td>
									<a href="transaksi-rincian.php?outlet=<?php echo $_GET['outlet']; ?>&&id=<?php echo $data['id']; ?>" class="btn btn-success">Rincian</a>
									<a href="transaksi-hapus_db.php?outlet=<?php echo $_GET['outlet']; ?>&&id=<?php echo $data['id']; ?>" onclick="return confirm('Yakin Hapus?')" class="btn btn-danger">Hapus</a>
								</td>
							</tr>
							<?php $i++ ?>
							<?php } ?>
