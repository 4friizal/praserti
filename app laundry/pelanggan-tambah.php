			...
			<div class="row">
				...
				<div class="col-lg-12">
					<div class="col-lg-12 latar_konten">
						...
						<form action="pelanggan-tambah_db.php" method="POST" class="container-form">
							<div class="form-group">
								<label>Nama:</label>
								<input class="form-control" type="text" name="nama" placeholder="Masukan Nama Lengkap"></input>
							</div>
							<div class="form-group">
								<label>Alamat:</label>
								<textarea class="form-control" type="text" name="alamat" placeholder="Masukan Alamat Lengkap"></textarea>
							</div>
							<div class="form-group">
