			...
			<div class="row">
				...
				<div class="col-lg-12">
					<div class="col-lg-12 latar_konten">
						...
						<form action="pengguna-tambah_db.php" method="POST" class="container-form">
							<div class="form-group">
								<label>Nama Pengguna:</label>
								<input class="form-control" type="text" name="nama_pengguna" placeholder="Masukan Nama Pengguna"></input>
							</div>
							<div class="form-group">
								<label>Username:</label>
								<input class="form-control" type="text" name="username" placeholder="Masukan Username"></input>
							</div>
							<div class="form-group">
								<label>Password:</label>
								<input class="form-control" type="password" name="password" placeholder="Masukan Password"></input>
							</div>
							<div class="form-group">
